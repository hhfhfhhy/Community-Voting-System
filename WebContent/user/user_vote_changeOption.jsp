...
<body onload="startTime()">
  ...
  <div id="bodycontent">
    <h5>
		...
		<a href="#"><span style="color:black;font-weight:normal;font-size:15px;">修改投票选项</span></a>
	</h5>
		<%
		...
		ArrayList<VoteEvent> currentVoteEvent=new ArrayList<VoteEvent>();
	  	...
	  	currentVoteEvent=myVoteBean.getVoteEvent(VoteID);//获得VoteID的所有VoteEvent
	%>
	<fieldset>
			<legend>修改投票选项</legend>
...
<form action="/OVS/ChangeVoteOptionServlet" name="myform" method="post"  onSubmit="javascript:return window.confirm('确认修改选项吗？')" > 
			<table>
				<%
